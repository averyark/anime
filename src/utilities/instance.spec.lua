...
return function ()
    ...
    describe("instance.makeInstance", function()
        ...
        it("should make a NumberValue with a value of 5 and name of \"_testEZ_NumberValue\" and a ObjectValue and a StringValue", function()
            local dummyInstance = instance.makeInstance("NumberValue", {
                Value = 5,
                Name = "_testEZ_NumberValue",
    ...
    local _dummyInstance = instance.makeInstance("NumberValue", {
        ...
        instance.makeInstance("NumberValue", {Name = "Test3", {
